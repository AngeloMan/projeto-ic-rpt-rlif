...
ADAPTER_PATH = "qwen-rlif-math-v1" # Nome da pasta do treino RLIF matemático
OUTPUT_FILE = "resultados_rlif_gsm8k.jsonl"
DEVICE = "cuda"
...
print(f"Acoplando o modelo RLIF: {ADAPTER_PATH}...")
...
print(f"Iniciando avaliação RLIF em {len(dataset)} problemas...")
...
print("\n" + "="*40)
print(f"ACURÁCIA RLIF GSM8K: {acuracia:.2f}% ({acertos}/{len(dataset)})")
print("="*40)