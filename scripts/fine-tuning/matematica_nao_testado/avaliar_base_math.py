...
OUTPUT_FILE = "resultados_base_gsm8k.jsonl"
DEVICE = "cuda"
...
# Carrega o conjunto de teste do GSM8K
dataset = load_dataset("gsm8k", "main", split="test")

print(f"Iniciando avaliação de {len(dataset)} problemas...")
...
# Salva resultados e calcula acurácia
...
print("\n" + "="*40)
print(f"ACURÁCIA BASE GSM8K: {acuracia:.2f}% ({acertos}/{len(dataset)})")
print("="*40)